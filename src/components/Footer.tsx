...
const Footer = () => {
  return (
    <footer className="bg-[#130D37]/80 backdrop-blur-sm border-t border-white/10">
      <div className="max-w-7xl m-0 md:mx-auto px-0 py-0 md:px-4 md:py-12">
        {/* Top Section: Only visible on desktop */}
        <div className="hidden md:grid grid-cols-4 gap-8 md:gap-12">
          {/* Brand Section */}
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3">
              <img src={logo1} alt="SRM ONE Logo" className="h-[40px] w-auto" />
              <span className="text-xl font-semibold">SRM ONE</span>
            </Link>
            <p className="text-gray-400 text-sm">
              Streamlining your learning process with powerful SRM tools and features.
        ...
        <div className="mt-0 pt-4 pb-4 border-t-0 md:mt-12 md:pt-8 md:border-t md:border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            <p className="text-gray-400 text-sm flex items-center font-gilroy">
              Made with <span className="mx-1">❣️</span> by SRM ONE Team
            </p>
